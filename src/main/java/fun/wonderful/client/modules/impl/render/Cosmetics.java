...
public class Cosmetics extends Module {
    ...
    private Identifier getNimbusTexture() {
        return Identifier.of("wonderful", "textures/targetesp/bloom.png");
    }
    ...
    private boolean shouldRenderCosmeticForPlayer(PlayerEntity player) {
        ...
        return Wonderful.INSTANCE != null
                && Wonderful.INSTANCE.friendStorage != null
                && Wonderful.INSTANCE.friendStorage.isFriend(player.getName().getString());
    }
    ...
    private int getStableThemeColor() {
        ...
        var theme = Wonderful.INSTANCE.themeStorage.getThemes().getTheme();
