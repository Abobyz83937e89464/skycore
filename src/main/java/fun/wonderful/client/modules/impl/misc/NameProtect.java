...
import fun.wonderful.mixin.ChatScreenAccessor;
...
public class NameProtect extends Module {
    ...
    private final TextSetting nickname = new TextSetting("Никнейм", "wonderful", 32);
    ...
    public String patch(String text) {
        ...
        if (friends.isState() && Wonderful.INSTANCE != null && Wonderful.INSTANCE.friendStorage != null) {
    ...
    public String getReplacementName() {
        ...
        return value == null || value.isBlank() ? "wonderful" : value;
    }
    ...
    private String patchGrief(String text) {
        ...
        String out = text.replaceAll("Анархия-\\d+", "wonderfulclient.fun");
        out = out.replaceAll("ГРИФ #\\d+", "wonderfulclient.fun");
        return out;
    }
    ...
    private String getPatchCacheKey(String text) {
        ...
        int friendsHash = 0;
        if (friends.isState() && Wonderful.INSTANCE != null && Wonderful.INSTANCE.friendStorage != null) {
            List<String> friendList = Wonderful.INSTANCE.friendStorage.getFriends();
    ...
    private boolean isFriendRemoveInputActive() {
        ...
        TextFieldWidget chatField = ((ChatScreenAccessor) chatScreen).wonderful$getChatField();
        if (chatField == null) {
            return false;
        }
        ...
        String prefix = Wonderful.INSTANCE != null && Wonderful.INSTANCE.commandStorage != null
                ? Wonderful.INSTANCE.commandStorage.getPrefix().toLowerCase()
                : ".";
