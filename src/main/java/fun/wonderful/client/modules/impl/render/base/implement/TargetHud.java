...
public class TargetHud extends InterfaceProcessing {
    ...
    public void DefaultStyle(EventRender.Default eventRender) {
        ...
        if (!Wonderful.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")) {
            colorTheme = Wonderful.INSTANCE.themeStorage.getThemes().getTheme().color[0];
        } else {
            colorTheme = ColorUtils.getThemeColor();
        }
        int colorTheme2;
        if (!Wonderful.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")) {
            colorTheme2 = ColorUtils.darken(Wonderful.INSTANCE.themeStorage.getThemes().getTheme().color[0], 0.4f);
        } else {
    ...
    public void WaveStyle(EventRender.Default eventRender) {
        ...
        int waveThemeColor = !Wonderful.INSTANCE.themeStorage.getThemes().getTheme().getName().equals("Rainbow")
                ? Wonderful.INSTANCE.themeStorage.getThemes().getTheme().color[0]
