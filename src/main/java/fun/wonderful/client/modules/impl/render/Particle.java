...
public class Particle extends Module {
    ...
    private static final Identifier STAR_TEXTURE = Identifier.of("wonderful", "textures/particle/star.png");
    private static final Identifier HEART_TEXTURE = Identifier.of("wonderful", "textures/particle/heart.png");
    private static final Identifier DOLLAR_TEXTURE = Identifier.of("wonderful", "textures/particle/dollar.png");
    private static final Identifier BLOOM_TEXTURE = Identifier.of("wonderful", "textures/particle/bloom.png");
    private static final Identifier SPARKLE_TEXTURE = Identifier.of("wonderful", "textures/particle/sparkle.png");
