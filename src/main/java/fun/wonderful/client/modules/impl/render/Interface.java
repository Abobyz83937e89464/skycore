...
import fun.wonderful.client.modules.impl.render.base.implement.*;
...
public class Interface extends Module {
    ...
    private static final long SLOW_HUD_ELEMENT_NANOS = Long.getLong("wonderful.perf.hudMs", 5L) * 1_000_000L;
    private static final long PERF_WARN_COOLDOWN_NANOS = Long.getLong("wonderful.perf.cooldownMs", 1000L) * 1_000_000L;
    ...
    public Interface() {
        ...
        this.waterMark = new WaterMark(Wonderful.draggable(this, "WaterMark", 10, 10));
        this.arrayListHud = new ArrayListHud(Wonderful.draggable(this, "ArrayList", 5, 24));
        this.keyBinds = new KeyBinds(Wonderful.draggable(this, "KeyBinds", 30, 30));
        this.helperBinds = new HelperBinds(Wonderful.draggable(this, "HelperBinds", 90, 30));
        this.potions = new Potions(Wonderful.draggable(this, "Potions", 30, 60));
        this.staffList = new StaffList(Wonderful.draggable(this, "StaffList", 60, 100));
        this.session = new Session(Wonderful.draggable(this, "Session", 70, 30));
        this.keyStrokes = new KeyStrokes(Wonderful.draggable(this, "KeyStrokes", 150, 120));
        this.information = new Information(Wonderful.draggable(this, "Information", 50, 100));
        this.notifications = new Notifications(Wonderful.draggable(this, "Notifications", 0, 0));
        this.targetHud = new TargetHud(Wonderful.draggable(this, "TargetHud", 30, 90));
    }
